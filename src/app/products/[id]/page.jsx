...
const PRODUCTS = [
  ...
  { id:13, name:"Kashmiri Pashmina Shawl", price:8999, category:"Luxury Fashion", tags:["women","luxury","wedding","anniversary"], rating:4.9, reviews:156, image:"https://images.unsplash.com/photo-1606107555365-1f3d6f12b8b5?w=800&q=90", badge:"Premium", desc:"Hand-woven 100% pure Pashmina wool. So-soft it passes through a ring.", stock:18, arSrc:null, longDesc:"This authentic Kashmiri Pashmina shawl is hand-woven by master artisans using 100% pure Changthangi goat wool. So fine that an entire shawl can pass through a wedding ring. Features intricate traditional Kashmiri embroidery. Ships in a silk-lined presentation box with care instructions and authenticity certificate." },
  { id:14, name:"Philips Hue Ambient Light Set", price:5499, category:"Home & Lifestyle", tags:["home","tech","decor","any"], rating:4.7, reviews:892, image:"https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=90", badge:"Top Rated", desc:"Smart ambient lighting with 16M colors. App-controlled, voice assistant ready.", stock:42, arSrc:null, longDesc:"Transform any space with the Philips Hue ambiance starter kit. Includes 3 smart bulbs and a Hue Bridge hub. Control 16 million colors via the Hue app, set schedules, and sync with music. Works with Alexa, Google Assistant, and Apple HomeKit. Perfect for creating mood lighting for any occasion." },
  { id:15, name:"Keychron K2 Mechanical Keyboard", price:3299, category:"Premium Tech", tags:["tech","work","gaming","productivity"], rating:4.8, reviews:567, image:"https://images.unsplash.com/photo-1595225476474-87563907a212?w=800&q=90", badge:null, desc:"Wireless mechanical keyboard with Gateron switches. Aluminum frame, RGB backlit.", stock:35, arSrc:null, longDesc:"The Keychron K2 is a 75% layout wireless mechanical keyboard featuring Gateron mechanical switches, RGB backlighting, and an aircraft-grade aluminum frame. Connects via Bluetooth to 3 devices or USB-C. Compatible with Mac and Windows. Includes extra keycaps for both layouts. A premium typing experience." },
  { id:16, name:"Montblanc Style Fountain Pen", price:4599, category:"Stationery", tags:["executive","writing","luxury","office"], rating:4.8, reviews:234, image:"https://images.unsplash.com/photo-1585336261022-680e295ce3fe?w=800&q=90", badge:"Premium", desc:"14K gold nib fountain pen with resin body. A writer's lifetime companion.", stock:22, arSrc:null, longDesc:"Inspired by classic Montblanc design, this luxury fountain pen features a genuine 14K gold nib with iridium tip, precious black resin body, and platinum-plated clip. Includes converter for bottled ink and 2 cartridges. Ships in a premium gift box with a polishing cloth and international warranty card." },
  { id:17, name:"Tibetan Singing Bowl Set", price:1899, category:"Wellness", tags:["wellness","meditation","yoga","peace"], rating:4.7, reviews:445, image:"https://images.unsplash.com/photo-1606216794074-735e91aa2c92?w=800&q=90", badge:null, desc:"Hand-hammered brass singing bowl with cushion & mallet. Deep resonance for meditation.", stock:55, arSrc:null, longDesc:"This authentic Tibetan singing bowl is hand-hammered by artisans in the Himalayan tradition using a special bronze alloy of 7 metals. Produces rich, sustained overtones ideal for meditation and sound therapy. Set includes the bowl (4.5\" diameter), silk cushion, wooden mallet, and a guide to singing bowl techniques." },
  { id:18, name:"Japanese Bonsai Starter Kit", price:2699, category:"Botanicals", tags:["plants","zen","hobby","home"], rating:4.6, reviews:178, image:"https://images.unsplash.com/photo-1567619690754-88ef1235e4e8?w=800&q=90", badge:"New", desc:"Complete bonsai kit with 3 tree varieties, pots, soil & care guide.", stock:38, arSrc:null, longDesc:"Begin your bonsai journey with this complete starter kit. Includes 3 young tree seedlings (Juniper, Ficus, and Japanese Maple), 3 ceramic training pots, premium bonsai soil mix, pruning shears, training wire, humidity tray, and a comprehensive 32-page care guide. Perfect for beginners and experienced gardeners alike." },
  { id:19, name:"Single Origin Coffee Collection", price:1999, category:"Gourmet Food", tags:["coffee","gourmet","morning","foodie"], rating:4.8, reviews:312, image:"https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800&q=90", badge:null, desc:"4 premium single-origin beans from Ethiopia, Colombia, Bali & Kenya. Fresh roasted.", stock:65, arSrc:null, longDesc:"A curated coffee journey featuring four 125g bags of single-origin specialty coffee: Ethiopian Yirgacheffe (floral, citrus), Colombian Huila (caramel, chocolate), Bali Blue Moon (spicy, full-bodied), and Kenyan AA (blackcurrant, wine-like). All beans are roasted to order within 48 hours of shipping. Includes tasting notes card." },
  { id:20, name:"Ridge Titanium Minimalist Wallet", price:3499, category:"Fine Accessories", tags:["men","minimalist","edc","modern"], rating:4.7, reviews:892, image:"https://images.unsplash.com/photo-1627123424574-724758594e93?w=800&q=90", badge:"Bestseller", desc:"RFID-blocking titanium wallet. Holds 12 cards + cash. Lifetime warranty included.", stock:48, arSrc:null, longDesc:"The Ridge Wallet is crafted from Grade 5 titanium with a military-grade Cerakote finish. Features RFID-blocking technology, holds 1-12 cards plus cash with the external money clip, and comes with a lifetime warranty. Only 8mm thick when fully loaded. Includes a Torx bit for adjustments. Ships in a premium gift box." },
  { id:21, name:"Custom Star Map Frame", price:1599, category:"Memories", tags:["anniversary","personalized","romance","custom"], rating:4.9, reviews:523, image:"https://images.unsplash.com/photo-1519689683798-3828fb4090bb?w=800&q=90", badge:"Top Rated", desc:"Personalized night sky map of any special date. Museum-quality frame included.", stock:72, arSrc:null, longDesc:"A custom star map showing the exact night sky from any date and location you choose. Printed on archival-quality 300gsm matte paper using pigment inks. Mounted in a solid wood frame with museum-grade glass. Perfect for anniversaries, first meetings, births, or any memorable moment. Includes gift wrapping and personalized message card." },
  { id:22, name:"Theory11 Luxury Playing Cards", price:1299, category:"Games & Leisure", tags:["cards","magic","collection","luxury"], rating:4.8, reviews:667, image:"https://images.unsplash.com/photo-1534349762230-e0cadf68f7d1?w=800&q=90", badge:null, desc:"Premium foil-stamped playing cards by Theory11. Gold foil, custom art, premium stock.", stock:88, arSrc:null, longDesc:"Theory11 produces the finest playing cards in the world. This luxury deck features custom artwork, metallic gold foil stamping, embossed accents, and premium casino-grade paper stock. Made in the USA with sustainable materials. Includes 52 cards + 2 jokers. Perfect for cardistry, magic, poker nights, or collectors." },
  { id:23, name:"Beginner Pottery Wheel Kit", price:5999, category:"Creative Arts", tags:["art","pottery","creative","hobby"], rating:4.6, reviews:89, image:"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=800&q=90", badge:"New", desc:"Compact electric pottery wheel with 5kg clay, tools & apron. Create at home.", stock:15, arSrc:null, longDesc:"A complete home pottery studio in one box. Includes a compact 25cm electric pottery wheel (0-300 RPM), 5kg of premium stoneware clay, 8-piece tool set, adjustable splash pan, canvas apron, wire clay cutter, and a comprehensive instruction manual. Wheel features adjustable legs and runs quietly at <60dB. Perfect for beginners." },
  { id:24, name:"Mulberry Silk Sleep Set", price:2799, category:"Wellness", tags:["women","sleep","beauty","self-care"], rating:4.9, reviews:445, image:"https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&q=90", badge:"Premium", desc:"22 Momme silk pillowcase, eye mask & scrunchie. Anti-aging, hypoallergenic.", stock:52, arSrc:null, longDesc:"A luxurious sleep set made from 100% Grade 6A Mulberry silk in 22 Momme weight. Set includes a standard/queen pillowcase with hidden zipper, contoured sleep mask, and large scrunchie. Hypoallergenic, temperature-regulating, and gentle on skin and hair. Available in Champagne, Charcoal, and Ivory. Ships in a silk storage pouch." },
  { id:25, name:"Audio-Technica Turntable", price:8999, category:"Premium Tech", tags:["music","vinyl","audiophile","retro"], rating:4.8, reviews:334, image:"https://images.unsplash.com/photo-1603048588665-791ca8aea617?w=800&q=90", badge:"Ultra Premium", desc:"Belt-drive turntable with AT-VM95E cartridge. Hi-Fi sound, built-in preamp.", stock:12, arSrc:null, longDesc:"The Audio-Technica AT-LP120XUSB is a professional belt-drive turntable with a DC servo motor, adjustable dynamic anti-skate control, and AT-VM95E dual moving magnet cartridge. Features built-in switchable phono preamp, USB output for digitizing records, and stroboscopic platter speed indicator. Includes felt mat, dust cover, and 45 RPM adapter." },
  { id:26, name:"Full-Grain Leather Belt", price:2199, category:"Fine Accessories", tags:["men","classic","leather","timeless"], rating:4.7, reviews:234, image:"https://images.unsplash.com/photo-1624222247344-550fb60583dc?w=800&q=90", badge:null, desc:"Italian vegetable-tanned leather belt. Solid brass buckle. Ages beautifully.", stock:40, arSrc:null, longDesc:"Handcrafted from full-grain Italian vegetable-tanned leather from the renowned Horween tannery. Features a solid brass buckle with antique finish, 1.5\" width, and 7-hole adjustment. The leather develops a rich patina over time, becoming uniquely yours. Available in sizes 30-44. Ships in a dust bag with care instructions." },
  { id:27, name:"Global Artisan Spice Box", price:1799, category:"Gourmet Food", tags:["cooking","spices","foodie","home"], rating:4.6, reviews:178, image:"https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=800&q=90", badge:null, desc:"9 exotic spices from around the world in wooden masala dabba. Recipe guide included.", stock:58, arSrc:null, longDesc:"A curated spice journey featuring 9 premium spices: Iranian Saffron, Tellicherry Black Pepper, Ceylon Cinnamon, Madagascar Vanilla, Spanish Smoked Paprika, Indian Cardamom, Turkish Sumac, Moroccan Ras el Hanout, and Chinese Five Spice. Presented in a traditional Indian teak wood masala dabba with spoon. Includes a 24-recipe guide from global cuisines." },
  { id:28, name:"Golden Acrylic Paint Set", price:3499, category:"Creative Arts", tags:["art","painting","professional","colors"], rating:4.8, reviews:267, image:"https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=800&q=90", badge:"Top Rated", desc:"24 heavy-body acrylics with easel & brushes. Artist-grade pigments.", stock:30, arSrc:null, longDesc:"A professional-grade acrylic paint set featuring 24 60ml tubes of heavy-body acrylics made with lightfast artist pigments. Includes a solid beech wood tabletop easel, 6 synthetic brushes (rounds and flats), palette knife, and 12x16\" stretched canvas. Conforms to ASTM D-4236 safety standards. Ideal for both studio and plein air painting." },
  { id:29, name:"Lead Crystal Decanter Set", price:6499, category:"Home & Lifestyle", tags:["bar","whiskey","elegant","home"], rating:4.9, reviews:145, image:"https://images.unsplash.com/photo-1575023782549-62ca0d244b39?w=800&q=90", badge:"Premium", desc:"Hand-cut lead crystal decanter + 4 tumblers. 24% PbO. Mahogany gift box.", stock:20, arSrc:null, longDesc:"A stunning bar set crafted from 24% lead crystal (PbO) using traditional hand-cutting techniques. The set includes a 750ml decanter with glass stopper and 4 matching 11oz old-fashioned tumblers featuring intricate diamond-cut patterns. Ships in a mahogany presentation box lined with velvet. Perfect for whiskey, scotch, or bourbon connoisseurs." },
  { id:30, name:"Jo Malone Fragrance Collection", price:7499, category:"Luxury Fashion", tags:["women","perfume","luxury","fragrance"], rating:4.9, reviews:567, image:"https://images.unsplash.com/photo-1541643600914-78a084683485?w=800&q=90", badge:"Ultra Premium", desc:"5 signature colognes in 9ml bottles. Luxe gift box with ribbon.", stock:25, arSrc:null, longDesc:"An exquisite discovery set featuring 5 of Jo Malone London's most beloved colognes in 9ml spray bottles: Lime Basil & Mandarin, English Pear & Freesia, Peony & Blush Suede, Wood Sage & Sea Salt, and Nectarine Blossom & Honey. Each scent can be worn alone or layered. Presented in a signature cream and black gift box with ribbon." },
];
