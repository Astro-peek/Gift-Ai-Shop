        ...
        <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: "20px", padding: "36px" }}>
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: "18px" }}>
              ...
              <input id="login-email" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@example.com" required style={inputStyle}/>
            </div>
            <div style={{ marginBottom: "24px" }}>
              ...
              <input id="login-password" type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" required style={inputStyle}/>
            </div>
          ...
          <div style={{ textAlign: "center", marginTop: "22px", fontSize: "13px", color: MUTED }}>
            ...
            <a href="/register" style={{ color: GOLD, fontWeight: 700, textDecoration: "none" }}>Create one →</a>
          </div>
        </div>
      </div>
    </div>
